    ...
    <>
      ...
      >
        <div className="container mx-auto lg:px-28 md:px-20 py-32 md:py-10 m-4">
          {/* Desktop View */}
          <div className="text-center text-white px-4 lg:px-10 py-20 md:py-40 hidden md:block space-y-8">
      ...
      {/* Mobile View */}
      <div className="text-center text-white px-10 md:px-5 mt-20 mb-15 md:py-40 block md:hidden space-y-6">
        <h1 className="text-4xl md:text-[75px] md:leading-[75px] font-[600] text-[#001748] text-left font-avenir-bold">
          Your business is only as healthy as the people in it.
        </h1>
        <p className="text-lg md:text-[22px] leading-8 text-[#3b3b3b] text-left mt-4">
          Sick days and loss of productivity can affect your bottom line. Get in touch with an agent to find healthcare coverage that helps you take care of your employees and your business.
        </p>
        <button
